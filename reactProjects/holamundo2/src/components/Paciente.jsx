  ...
  return (
    <div className='mt-5 shadow-xl bg-white p-5 rounded-lg uppercase mb-3 text-gray-700 font-bold'>
      ...
      <div className="flex justify-evenly gap-4 mt-4">
        ...
        <input type="button" value="Eliminar" className='bg-orange-500 font-bold  p-2 text-white w-full rounded-md hover:bg-black hover:cursor-pointer' onClick={handleEliminar} />
      </div>
